 ...
 */
class CRM_Nbrportalstuff_Upgrader_Base {

  /**
   * @var CRM_Nbrportalstuff_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Nbrportalstuff_Upgrader(
        'nbrportalstuff',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Nbrportalstuff_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Nbrportalstuff_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
